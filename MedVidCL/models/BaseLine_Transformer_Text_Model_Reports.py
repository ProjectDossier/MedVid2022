...
parser.add_argument(
    ...
    type=int,
    default=3,
    help="Number of epochs to wait before terminating training if no improvement",
)
parser.add_argument(
    "--evaluation_metric",
    type=str,
    default="eval_f1",
    help="Metric to use to track and choose best model",
)
parser.add_argument(
...
def train_and_test_Transformer_Model(
    model_name="google/bigbird-roberta-base", max_token_length=1024, batch_size=8
):
    # Set variables
