...
train_and_test_lstm(
    dls,
    "./tmp/lstm_i3d_trained_state_dict.pt",
    I3D_MAX_SEQ_LENGTH,
    I3D_NUM_FEATURES,
    args.batch_size,
...
train_and_test_lstm(
    vit_dls,
    "./tmp/lstm_vit_trained_state_dict.pt",
    VIT_MAX_SEQ_LENGTH,
    VIT_NUM_FEATURES,
    args.batch_size,
    args.lstm_learning_rate,
...
trained_model = train_and_test_transformer(
    transformer_datasets,
    transformer_labels,
    "./tmp/transformer_i3d_video_classifier",
    I3D_MAX_SEQ_LENGTH,
    I3D_NUM_FEATURES,
...
vit_trained_model = train_and_test_transformer(
    vit_transformer_datasets,
    vit_transformer_labels,
    "./tmp/transformer_vit_video_classifier",
    VIT_MAX_SEQ_LENGTH,
    VIT_NUM_FEATURES,
    args.transformer_learning_rate,
)
