...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--output_folder", default="data/processed/predictions/passage_similarity/merged/"
    )
    parser.add_argument(
    ...
    csv_files = [x for x in os.listdir(f"{args.input_folder}/{args.dataset}") if x.endswith(".csv")]
